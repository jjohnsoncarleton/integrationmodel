filename = 'Segregation_Contact_Hypothesis_v7_repulsion Media-Hetero-50-width-90-table';
...
ylabel('Green Media $g_{G}(i)$','Interpreter','LaTeX')
xlabel('Red Media $g_{R}(i)$','Interpreter','LaTeX')
title('Final Average Intolerance Red','Interpreter','LaTeX')
caxis([0 70])
colorbar
set(gca,'FontSize',30)
view(-90,90)
...
ylabel('Green Media $g_{G}(i)$','Interpreter','LaTeX')
xlabel('Red Media $g_{R}(i)$','Interpreter','LaTeX')
title('Final Average Intolerance Green','Interpreter','LaTeX')
caxis([0 70])
colorbar
set(gca,'FontSize',30)
view(-90,90)
