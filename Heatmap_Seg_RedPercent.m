filename = 'Segregation_Contact_Hypothesis_v8_corrected_division Repulsion-Test-Intolerance-Red-Per-Vary-Sim-Want-50-table.csv';
...
WantFinal = reshape(WantFinal,11,9);
WantFinalG = reshape(WantFinalG,11,9);
WantFinalR = reshape(WantFinalR,11,9);
PerSim = table2array(T(:,21));
PerSim = reshape(PerSim,11,9);
...
filename = 'Segregation_Contact_Hypothesis_v8_corrected_division Repulsion-Test-Intolerance-Red-Per-Vary-Sim-Want-25-table.csv';
...
WantFinal25 = reshape(WantFinal25,11,9);
WantFinal25G = reshape(WantFinal25G,11,9);
WantFinal25R = reshape(WantFinal25R,11,9);
PerSim25 = table2array(T25(:,21));
PerSim25 = reshape(PerSim25,11,9);
